...
(load-extension
	(string-append opencog-ext-path-sensory-v0 "libsensory-v0")
	"opencog_sensory_v0_init")

(load-extension
	(string-append opencog-ext-path-sensory-v0 "libsensory-v0-filedir")
	"opencog_sensory_v0_filedir_init")

(load-extension
	(string-append opencog-ext-path-sensory-v0 "libsensory-v0-irc")
